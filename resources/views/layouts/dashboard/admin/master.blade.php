...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('assets/admin-dashboard/vendors/bootstrap-datepicker/bootstrap-datepicker.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/admin-dashboard/vendors/datatables.net-bs4/dataTables.bootstrap4.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('assets/admin-dashboard/vendors/bootstrap-icons/bootstrap-icons.css') }}">

    {{-- JQuery --}}
    {{-- <script src="https://code.jquery.com/jquery-3.7.1.js"></script> --}}
    {{-- <link rel="stylesheet" href="{{ asset('assets/admin-dashboard/css/include/jquery.dataTables.min.css') }}"> --}}
...
<body>
            ...
            <div class="sidebar-body">
                ...
                <div class="theme-wrapper">
                    ...
                    <a class="theme-item active" href="../demo_1/dashboard-one.html">
                        <img src="{{ asset('assets') }}/dashboard/images/screenshots/light.jpg" alt="light theme">
                    </a>
                    <h6 class="text-muted mb-2">Dark Theme:</h6>
                    <a class="theme-item" href="../demo_2/dashboard-one.html">
                        <img src="{{ asset('assets') }}/dashboard/images/screenshots/dark.jpg" alt="light theme">
                    </a>
                </div>
            </div>
        </nav> --}}
    ...
    <script src="{{ asset('assets/admin-dashboard/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js') }}"></script>
    ...
    <script src="{{ asset('assets/admin-dashboard/js/datepicker.js') }}"></script>
