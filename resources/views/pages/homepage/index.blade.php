                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                ...
                                <div class="d-flex">
                                    <div class="form-group mr-2">
                                        ...
                                        <input type="text" class="form-control" name="pick_date" id="book_pick_date"
                                            placeholder="Date">
                                    </div>
                                    <div class="form-group ml-2">
                                        <label for="" class="label">Drop-off date</label>
                                        <input type="text" class="form-control" name="drop_date" id="book_off_date"
                                            placeholder="Date">
                                    </div>
                                </div>
                                {{-- <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="time_pick" placeholder="Time">
                                ...
                                <div class="form-group">
                                    <button type="submit" value="Rent A Car Now" class="btn btn-secondary py-3 px-4">Rent A
                                        Car Now</button>
                                </div>
                            </form>
                        </div>
                                ...
                                <div class="car-wrap rounded ftco-animate">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="d-flex mb-3">
                                            ...
                                            <p class="price ml-auto">Tk {{ $car->daily_rent_price }} <span>/day</span></p>
                                        </div>
                                        <p class="text-center mb-0 d-block">
                                            <a href="{{ route('cars.book', $car->id) }}"
...
style="background-image: url({{ asset('assets') }}/home-page/images/bg_3.jpg);">
<div class="overlay"></div>
<div class="container">
